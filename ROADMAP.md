...
### Phase 10.5 최신 D-AX 진행 메모 (2026-05-15)
...
- D-AX-13: `/auth/me` + login/refresh auth contract 정합 진행. admin `loginId/fullName`, driver `driverCode/phoneNumber` 공개 식별자를 BE/FE 모두에서 보존.
- 다음 후보: `clients/arologis-mobile` 로 signature / photo 화면 이식, 또는 실제 기기 QA 및 `mobile-staff` driver mode 제거.
