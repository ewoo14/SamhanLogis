...
> **정정(2026-08-07, PR #1082 R2)**: 위 line_id는 증거 스플라이스 값이다. 읽기 전용 DB 재조회 기준 실제 line_id는 `3c4ceb75-1e26-4e9d-a879-cccb1df7a477`이다. 꼬리 `97d9b2d55545`의 출처는 `④-2 partner-order line_id`이며, 기존 표의 결론·원문은 보존한다.
