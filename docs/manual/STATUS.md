...
| **Stage 5 (Phase 11 이후)** | 백업·복원 운영 매뉴얼 부속 + 잔여 장기 backlog PR 머지 시 안내 docs 정식 본문으로 교체 (견적서 legacy 마이그레이션 / 재고 실사 ✅PR#148 / 월말 마감 ✅PR#148 / 거래처 PWA 자가 등록 일부). Phase 11 AWS ✅PR#152 완료로 운영 환경 확보됨. | ⏳ 잔여 장기 backlog 완료 후 | W11+ | 장기 backlog |
...
| 2 | `03-회계/02-보고서.md` | ✅ (11건 운영 + 잔여 5건 장기 backlog) | P0-1 ✅PR#134/136/137 | 11개 보고서 정식 운영. 잔여 5건 장기 backlog (계정원장/원천세/합계잔액시산표/분개장/부서별 손익) |
| 3 | `03-회계/03-세금계산서.md` | ✅ (정식 운영) | P0-4 ✅PR#138/139 | 세금계산서 발행/취소/인쇄 정식 운영. NTS API 연계는 장기 backlog |
| 4 | `03-회계/04-월말-마감.md` | ✅ (정식 운영) | P2-3 ✅PR#148 | 월말 마감 정식 운영 |
...
| 3 | `04-모바일/03-영업-앱.md` | ✅ (정식 운영) | P1-4 ✅PR#144 | 영업직원 mobile-staff estimate mode + legacy WebView 임베드 정식 출시. Native 견적/주문 앱은 장기 backlog |
| 4 | `04-모바일/04-사진-첨부.md` | ✅ (정식 운영) | P1-8 ✅PR#147 | 검수/배송/영업 방문 3종 MinIO storage + RN 카메라/갤러리 정식 운영 |

#### 3.1.3 arologis (3 docs)

| # | 파일 | 상태 | 의존 / 차단 | 비고 |
|---|---|---|---|---|
| 1 | `05-arologis/01-카카오톡-배차.md` | ✅ (정식 운영) | P1-5 ✅PR#145 | backend `KakaoDispatchParser` ✅ + Frontend admin UI `/arologis/admin/auto-dispatch` 정식 운영 |
| 2 | `05-arologis/02-수동-배차.md` | ✅ | P1-5 ✅PR#145 | `/arologis/admin/manual-dispatch` 정식 admin 배차 UI 운영 |
| 3 | `05-arologis/03-기사-배정.md` | ✅ (정식 운영) | P1-5 ✅PR#145 | `/arologis/admin/driver-assignment` 2-panel 배정 UI 정식 운영. 자동 매칭 알고리즘 고도화는 장기 backlog |
...
| 4 | 영업 | `01-영업/01-거래처-등록.md` | ✅ (P0-6 ✅PR#141) | 📸 |
...
| 16 | 회계 | `03-회계/02-보고서.md` | ✅ (11건 운영 + 잔여 5건 장기 backlog) | 📸 |
| 17 | 회계 | `03-회계/03-세금계산서.md` | ✅ (P0-4 ✅PR#138/139) | 📸 |
| 18 | 회계 | `03-회계/04-월말-마감.md` | ✅ (P2-3 ✅PR#148) | — |
| 19 | 모바일 | `04-모바일/01-기사-앱.md` | ✅ | 📸 |
| 20 | 모바일 | `04-모바일/02-전자-서명.md` | ✅ | 📸 |
| 21 | 모바일 | `04-모바일/03-영업-앱.md` | ✅ (P1-4 ✅PR#144) | 📸 |
| 22 | 모바일 | `04-모바일/04-사진-첨부.md` | ✅ (P1-8 ✅PR#147) | 📸 |
| 23 | arologis | `05-arologis/01-카카오톡-배차.md` | ✅ (P1-5 ✅PR#145) | 📸 |
| 24 | arologis | `05-arologis/02-수동-배차.md` | ✅ | 📸 |
| 25 | arologis | `05-arologis/03-기사-배정.md` | ✅ (P1-5 ✅PR#145) | 📸 |
...
### 4.2 정식 교체 완료 + 잔여 장기 backlog

아래 9건은 Stage 3~4 시점 미구현 안내 docs 였으나 현재는 PR 머지로 대부분 정식 운영으로 전환됨.

| # | 파일 | 이전 차단 슬라이스 | 현 상태 |
|---|---|---|---|
| 1 | `01-영업/06-견적서.md` | (legacy v2 — 마이그레이션 미정) | ⏳ 장기 backlog — legacy WebView 임베드 운영 중 |
| 2 | `02-창고/04-매출-마감.md` | P2-4 매출 마감 | ✅ PR#148 정식 운영 |
| 3 | `02-창고/05-재고-실사.md` | P2-6 재고 실사 | ✅ PR#148 정식 운영 |
| 4 | `03-회계/02-보고서.md` | P0-1 14건 | ✅ PR#134/136/137 — 11건 운영 + 잔여 5건 장기 backlog |
| 5 | `03-회계/03-세금계산서.md` | P0-4 세금계산서 | ✅ PR#138/139 정식 운영 |
| 6 | `03-회계/04-월말-마감.md` | P2-3 월말 마감 | ✅ PR#148 정식 운영 |
| 7 | `04-모바일/03-영업-앱.md` | P1-4 영업 모바일 native | ✅ PR#144 정식 출시 (legacy WebView estimate mode) |
| 8 | `04-모바일/04-사진-첨부.md` | 신규 P1 사진 첨부 | ✅ PR#147 정식 운영 |
| 9 | `05-arologis/01-카카오톡-배차.md` | P1-5 카카오톡 UI | ✅ PR#145 정식 운영 |
| 10 | `05-arologis/03-기사-배정.md` | P1-5 기사 배정 UI | ✅ PR#145 정식 운영 |

**잔여 장기 backlog (의도된 미구현)**: 견적서 legacy 완전 마이그레이션 / NTS API 전자세금계산서 연계 / 회계 보고서 5건 (계정원장/원천세/합계잔액시산표/분개장/부서별 손익) / 권한 매트릭스 시각화 / 사용자 커스텀 단축키 / 거래처 자가 등록 PWA 일부 / 기사 자동 매칭 고도화.
