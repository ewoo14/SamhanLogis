...
- [Claude + Codex 5-agent 양쪽 리뷰 + TM 통합 게시](feedback_dual_5agent_review.md) — 2026-05-17 사용자 정정 (2회차). **Claude 5 + Codex 5 = 10 reviewer 병렬 + TM 통합 2 PR comment 게시** (Claude TM 통합 1 + Codex TM 통합 1). 각자 5+5=10 별도 등록 폐기. raw markdown 은 docs/qa 저장만.
