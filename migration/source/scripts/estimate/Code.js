// 노션 인증 데이터베이스
const AUTH_TOKEN = 'REDACTED_NOTION_AUTH_TOKEN_001';
...
function doGet() {
  ...
  const authResult = checkUserAuth(userEmail);
...
var NOTION_TOKEN = 'REDACTED_NOTION_TOKEN_002';
var NOTION_VER   = '2025-09-03';
const NOTION_TOKEN_ORDER = 'REDACTED_NOTION_TOKEN_ORDER_003';
...
// 전표발송 내역 Notion
const NOTION_KEY_SEND = 'REDACTED_NOTION_TOKEN_SHIPPING_004';
...
function logFrontEvent(group, msg, isMobile, mgrName) {
  ...
  try {
    UrlFetchApp.fetch('https://api.notion.com/v1/pages', {
      method: 'post',
      headers: {
        'Authorization': 'Bearer REDACTED_NOTION_TOKEN_BEARER_005',
        'Notion-Version': '2022-06-28',
        'Content-Type': 'application/json'
      },
      payload: JSON.stringify(payload),
...
/* 노션 설정 */
const NOTION_TOKEN_QUOTE = 'REDACTED_NOTION_TOKEN_QUOTE_006';
