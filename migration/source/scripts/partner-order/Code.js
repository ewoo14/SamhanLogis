...
const NOTION_TOKEN_AUTH = 'REDACTED_NOTION_TOKEN_AUTH_008';
...
const NOTION_TOKEN_SNAPSHOT = 'REDACTED_NOTION_TOKEN_SNAPSHOT_009';
...
function getAccessExpiration(bizNo) {
  ...
  const NOTION_TOKEN_LOG = 'REDACTED_NOTION_TOKEN_LOG_007';
  const NOTION_DB_ID_LOG = '2eda1006d65880d696b3da4a8d281ea2';
  const NOTION_TOKEN_SHIPPING = 'REDACTED_NOTION_TOKEN_SHIPPING_004';
