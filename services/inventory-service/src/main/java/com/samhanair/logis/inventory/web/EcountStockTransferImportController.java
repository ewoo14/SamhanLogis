...
/** MIG-5 — Admin 이카운트 창고이동 CSV import. */
@Slf4j
@RestController
@RequestMapping("/admin/inventory/stock-transfers/imports")
@RequiredArgsConstructor
@Tag(name = "MIG-5 — 이카운트 창고이동 마이그레이션")
public class EcountStockTransferImportController {

    private static final String PAGE_CODE = "ecount.mig5.stock-transfer";
    ...
    @Operation(summary = "이카운트 창고이동 CSV 적재")
    ...
    private void checkEditPermission(String actorRole) {
        ...
        if (!canEdit && dynamicPermissionClient.canView(actorRole, PAGE_CODE)) {
            ...
            throw new BusinessException(ErrorCode.FORBIDDEN,
                    "동적 권한 설정에 의해 창고이동 import 권한이 차단되었습니다.");
        }
    }
}
