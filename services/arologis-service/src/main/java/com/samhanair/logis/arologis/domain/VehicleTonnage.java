 ...
 *
 * <p>현재 active 9 값 (Samhan Public 배차 메뉴 UI 노출). legacy 2 값은 카톡 파싱 backward compat
 * 유지 (KakaoDispatchParser 가 "1.4톤" / "11톤,25톤" 입력을 받아도 동작).
 *
 ...
 * </ul>
 *
 * <h2>Legacy 2 (deprecated, 카톡 파싱 호환)</h2>
 * <ul>
