...
--
-- 초기 MASTER 계정 (admin / admin1234) — BCrypt strength 10 해시.
...
--
-- 해시 검증 = BcryptHashGenTest.v9_seed_hash_matches_admin1234 (test 회귀 가드).
...
VALUES (
    gen_random_uuid(),
    'admin',
    '$2a$10$EtZy/ChJX19rLJJ0pomWhuaWs/ii5yP9/RX1XU.vkegdiR4Rrg9gi',  -- admin1234 (BCrypt 10)
    '아로로지스 관리자',
    'AROLOGIS_MASTER',
    now(),
    'system',
