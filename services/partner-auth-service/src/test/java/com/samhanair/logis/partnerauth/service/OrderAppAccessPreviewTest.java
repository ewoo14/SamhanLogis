...
class OrderAppAccessPreviewTest {
    ...
    void previewExposesDeferredLookupInsteadOfSilentlyReturningNoCandidates() {
        ...
        when(activityReader.read("7777777777", "P-DEFERRED"))
    ...
    void previewUsesOrderAndShipmentActivityInsteadOfLoginOrPasswordDates() {
        ...
        when(activityReader.read("3333333333", "P003")).thenReturn(new PartnerActivity(
                LocalDateTime.now().minusDays(2), LocalDateTime.now().minusDays(40)));
        when(activityReader.read("4444444444", "P004")).thenReturn(new PartnerActivity(
    ...
    void previewUsesFixedLegacyThirtyDaysAndIgnoresLoginBaseline() {
        ...
        when(activityReader.read("1111111111", "P001")).thenReturn(new PartnerActivity(
                LocalDateTime.now().minusDays(45), null));
        when(activityReader.read("2222222222", "P002")).thenReturn(new PartnerActivity(
    ...
    void previewIncludesApprovedPartnerWithNoActivityWhenAuthWasCreatedOverThirtyDaysAgo() {
        ...
        when(activityReader.read("5555555555", "P005")).thenReturn(new PartnerActivity(null, null));
        when(activityReader.read("6666666666", "P006")).thenReturn(new PartnerActivity(null, null));
