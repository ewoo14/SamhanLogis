-- V72__grant_developer_app_release_permission.sql
-- DEV-1 개발 메뉴: DEVELOPER 에 admin.app-release 4-action 권한을 부여한다.
...
VALUES
    (gen_random_uuid(), 'DEVELOPER', 'admin.app-release', TRUE, TRUE, NOW(), 'v72-dev-menu-dev1', NOW(), 'v72-dev-menu-dev1', FALSE)
ON CONFLICT (role_code, page_code) WHERE is_deleted = FALSE DO UPDATE
SET can_view = TRUE,
    can_edit = TRUE,
    modified_at = NOW(),
    modified_by = 'v72-dev-menu-dev1';
...
VALUES
    (gen_random_uuid(), 'DEVELOPER', 'admin.app-release',
     TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE,
     NOW(), 'v72-dev-menu-dev1', NOW(), 'v72-dev-menu-dev1', FALSE)
ON CONFLICT (role_code, page_code) WHERE is_deleted = FALSE DO UPDATE
SET can_view = TRUE,
    can_create = TRUE,
    can_update = TRUE,
...
INSERT INTO group_page_permissions
    (id, group_id, page_code,
     ...
     created_at, created_by, modified_at, modified_by, is_deleted)
VALUES
    (gen_random_uuid(), '00000000-0000-0000-0000-000000000109'::uuid, 'admin.app-release',
     TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE,
     NOW(), 'v72-dev-menu-dev1', NOW(), 'v72-dev-menu-dev1', FALSE)
...
JOIN group_page_permissions gpp
 ...
 AND gpp.page_code = 'admin.app-release'
WHERE ag.is_deleted = FALSE
  AND ag.group_id = '00000000-0000-0000-0000-000000000109'::uuid
  AND NOT EXISTS (
      SELECT 1
