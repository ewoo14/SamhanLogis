-- V71__seed_app_release_page_permission.sql
-- 앱 릴리스 관리 page-code: admin.app-release.
--
-- 버전관리 + 자동업데이트 V1a admin CRUD 전용 권한이다.
-- dashboard.admin 과 분리해 릴리스 등록/강제 업데이트 정책 변경 권한을 별도로 위임할 수 있게 한다.
