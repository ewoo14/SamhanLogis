-- V31__add_developer_partner_matrix_rows.sql
-- SP-D6-2 cycle 1e: DEVELOPER/PARTNER role 을 권한 매트릭스 기본 행에 통합.
-- V30 의 명시 TRUE row 는 ON CONFLICT DO NOTHING 으로 보존한다.
