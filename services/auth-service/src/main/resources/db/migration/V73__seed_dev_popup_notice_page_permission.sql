-- V73__seed_dev_popup_notice_page_permission.sql
-- DEV-2 개발 메뉴: 팝업공지 page-code(dev.popup-notice)와 MASTER/DEVELOPER 4-action 권한.
...
JOIN group_page_permissions gpp
 ...
 AND gpp.page_code = 'dev.popup-notice'
