...
/**
 * V82 partners.delete RESTORE 시드 검증 — E2 거래처 취소선 복원.
 */
@SpringBootTest(
        classes = AuthServiceApplication.class,
        webEnvironment = SpringBootTest.WebEnvironment.NONE
)
class AuthFlywayV82SeedIT extends AbstractPostgresIT {

    private static final String PAGE_CODE = "partners.delete";

    @Autowired
    private JdbcTemplate jdbcTemplate;

    @Test
    @DisplayName("V82는 MASTER 역할/그룹에 partners.delete can_restore를 seed하고 delete grant를 보존한다")
    void masterTemplateAndGroupHaveRestore() {
    ...
    @Test
    @DisplayName("V82는 partners.delete RESTORE 계정 캐시를 materialize하고 시스템 마스터는 bypass로 제외한다")
