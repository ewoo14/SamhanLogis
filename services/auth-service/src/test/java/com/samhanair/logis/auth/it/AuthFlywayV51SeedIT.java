...
/** V51 아로로지스 간이 회계 page-code 권한 시드 검증. */
@SpringBootTest(
        classes = AuthServiceApplication.class,
        webEnvironment = SpringBootTest.WebEnvironment.NONE
)
class AuthFlywayV51SeedIT extends AbstractPostgresIT {
    ...
    @Test
    @DisplayName("V51은 role_page_permissions에 MASTER/MANAGER 회계 전권(view,edit)을 seed한다")
