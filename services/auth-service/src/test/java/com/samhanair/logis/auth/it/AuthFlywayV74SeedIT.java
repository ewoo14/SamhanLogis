...
/** V74 dev.activity-log page-code seed 검증. */
@SpringBootTest(classes = AuthServiceApplication.class, webEnvironment = SpringBootTest.WebEnvironment.NONE)
class AuthFlywayV74SeedIT extends AbstractPostgresIT {

    private static final String PAGE_CODE = "dev.activity-log";
    ...
    @Test
    @DisplayName("dev.activity-log는 PageCode enum과 MASTER/DEVELOPER 4-action seed에 등록된다")
    void v74SeedsActivityLogPermissions() {
