...
class EcountReimportControllerIT {
    ...
    void masterCanRunReimport() throws Exception {
        when(reimportService.reimportSlice("mig-3", "tester")).thenReturn(result("mig-3", 4, 2, 2, 10, 1));
    ...
    void unknownSliceReturns422() throws Exception {
        when(reimportService.reimportSlice("mig-99", "tester"))
    ...
    void emptyRawDirectoryReturnsZeroResult() throws Exception {
        when(reimportService.reimportSlice("mig-11", "tester")).thenReturn(result("mig-11", 0, 0, 0, 0, 0));
    ...
    void idempotentFilesAreSkipped() throws Exception {
        when(reimportService.reimportSlice("mig-4", "tester")).thenReturn(result("mig-4", 3, 0, 3, 0, 0));
