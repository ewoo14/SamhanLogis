...
class AuthAccountLookupClientTest {
    ...
    private static final String ENDPOINT =
            "http://auth-service/auth/internal/accounts/by-login?loginId=manager01";
    ...
    void sendsInternalTokenAndParsesEnvelopeAccountId() {
        server.expect(once(), requestTo(ENDPOINT))
                ...
                .andRespond(withSuccess("""
                        {"success":true,"data":{"accountId":"00000000-0000-0000-0000-000000000101"}}
                        """, MediaType.APPLICATION_JSON));

        Optional<UUID> result = client.findAccountIdByLoginId("manager01");

        assertThat(result).contains(UUID.fromString("00000000-0000-0000-0000-000000000101"));
        server.verify();
    }
    ...
    void returnsEmptyOnNotFoundAndServerError() {
        ...
        assertThat(client.findAccountIdByLoginId("manager01")).isEmpty();
        assertThat(client.findAccountIdByLoginId("manager01")).isEmpty();
        server.verify();
    }
    ...
    void skipsRequestWhenTokenIsBlank() {
        ...
        assertThat(noTokenClient.findAccountIdByLoginId("manager01")).isEmpty();
        noCallServer.verify();
    }
