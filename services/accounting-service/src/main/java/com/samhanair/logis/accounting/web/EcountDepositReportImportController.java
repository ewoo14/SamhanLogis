...
/** MIG-5 — Admin 이카운트 입금보고서 CSV import. */
@Slf4j
@RestController
@RequestMapping("/admin/accounting/deposit-reports/imports")
@RequiredArgsConstructor
@Tag(name = "MIG-5 — 이카운트 입금보고서 마이그레이션")
public class EcountDepositReportImportController {

    private static final String PAGE_CODE = "ecount.mig5.deposit-report";
    private static final String ROLE_HEADER = "X-User-Role";

    private final EcountDepositReportImporter importer;
    ...
    @Operation(summary = "이카운트 입금보고서 CSV 적재")
    ...
    private void checkEditPermission(String actorRole) {
        ...
        if (!canEdit && dynamicPermissionClient.canView(actorRole, PAGE_CODE)) {
            ...
            throw new BusinessException(ErrorCode.FORBIDDEN,
                    "동적 권한 설정에 의해 입금보고서 import 권한이 차단되었습니다.");
        }
    }
}
