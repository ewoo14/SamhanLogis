...
/** MIG-11 — Admin 이카운트 매출장 XLSX import. */
@Slf4j
@RestController
@RequestMapping("/admin/accounting/sales-ledger/imports")
@RequiredArgsConstructor
@Tag(name = "MIG-11 — 이카운트 매출장 마이그레이션")
public class Mig11SalesLedgerImportController {

    private static final String PAGE_CODE = "ecount.mig11.sales-ledger";
    private static final String ROLE_HEADER = "X-User-Role";

    private final EcountSalesLedgerImporter importer;
    ...
    private void checkEditPermission(String actorRole) {
        ...
        if (!canEdit && dynamicPermissionClient.canView(actorRole, PAGE_CODE)) {
            ...
            throw new BusinessException(ErrorCode.FORBIDDEN,
                    "동적 권한 설정에 의해 매출장 import 권한이 차단되었습니다.");
        }
    }
}
