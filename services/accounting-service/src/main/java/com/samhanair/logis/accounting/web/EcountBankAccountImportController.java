...
/** MIG-6 — Admin 이카운트 통장계좌 CSV import. */
@Slf4j
@RestController
@RequestMapping("/admin/accounting/bank-accounts/imports")
@RequiredArgsConstructor
@Tag(name = "MIG-6 — 이카운트 통장계좌 마이그레이션")
public class EcountBankAccountImportController {

    private static final String PAGE_CODE = "ecount.mig6.bank-account";
    private static final String ROLE_HEADER = "X-User-Role";

    private final EcountBankAccountImporter importer;
    ...
    private void checkEditPermission(String actorRole) {
        ...
        if (!canEdit && dynamicPermissionClient.canView(actorRole, PAGE_CODE)) {
            ...
            throw new BusinessException(ErrorCode.FORBIDDEN,
                    "동적 권한 설정에 의해 통장계좌 import 권한이 차단되었습니다.");
        }
    }
}
