...
/** MIG-3 — Admin 이카운트 매입전표 CSV import. */
@Slf4j
@RestController
@RequestMapping("/admin/accounting/purchase-slips/imports")
@RequiredArgsConstructor
@Tag(name = "MIG-3 — 이카운트 매입전표 마이그레이션")
public class EcountPurchaseSlipImportController {

    /** Codex BE M6 cycle 2 — MIG-3 매입전표 import 페이지 코드 (SP-D2 동적 권한). */
    private static final String PAGE_CODE = "accounting.ecount.mig3.purchase-slip";
        ...
        if (!canEdit) {
            ...
            if (canView) {
                ...
                throw new BusinessException(ErrorCode.FORBIDDEN,
                        "동적 권한 설정에 의해 매입전표 import 권한이 차단되었습니다.");
            }
        }
    }
}
