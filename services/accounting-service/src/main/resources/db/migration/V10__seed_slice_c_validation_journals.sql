...
--
-- [격리 원칙] PR #137 BE+DevOps reviewer fix:
--   TrialBalanceControllerIT 가 period=202605 로 조회하므로,
--   V10 seed 의 모든 분개 일자를 2027-01 (격리된 월)로 변경하여 회귀 방지.
--
-- 계정과목 참조 (V1 기준):
--   101  현금             ASSET
--   102  보통예금         ASSET
...
--   819  임차료           SGA
--
-- 분개 7건 목록 (2027-01 격리 월 기준):
--   현금흐름 검증 (CFO / CFI / CFF 각 활동 포함) — 5건
--   SEED-CF-001  CFO — 외상매출금 현금 회수         2027-01-05
--   SEED-CF-002  CFO — 임차료 현금 지급             2027-01-10
--   SEED-CF-003  CFO — 상품 매입 외상 결제          2027-01-15
--   SEED-CF-004  CFI — 차량운반구 취득 (현금 지급)  2027-01-20
--   SEED-CF-005  CFF — 장기차입금 차입 (현금 유입)  2027-01-25
--
--   자본변동 검증 — 2건
--   SEED-EQ-001  유상증자 (자본금 납입)             2027-01-02
--   SEED-EQ-002  배당금 지급 (이익잉여금 감소)      2027-01-30
--
-- UUID 목록 (결정적):
...
VALUES
-- 2027-01-02: SEED-EQ-001 (격리 월 2027-01)
(gen_random_uuid(), '2027-01-02', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM', FALSE),
-- 2027-01-05: SEED-CF-001
(gen_random_uuid(), '2027-01-05', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM', FALSE),
-- 2027-01-10: SEED-CF-002
(gen_random_uuid(), '2027-01-10', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM', FALSE),
-- 2027-01-15: SEED-CF-003
(gen_random_uuid(), '2027-01-15', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM', FALSE),
-- 2027-01-20: SEED-CF-004
(gen_random_uuid(), '2027-01-20', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM', FALSE),
-- 2027-01-25: SEED-CF-005
(gen_random_uuid(), '2027-01-25', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM', FALSE),
-- 2027-01-30: SEED-EQ-002
(gen_random_uuid(), '2027-01-30', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM', FALSE)
...
-- SEED-CF-001: CFO — 외상매출금 현금 회수 (2027-01-05, 격리 월)
...
VALUES (
    ...
    'SEED-CF-001', '2027-01-05',
    '[DEV-SEED] CFO — 외상매출금 현금 회수 (현금흐름표 영업활동 유입 검증)',
    'MANUAL', 'POSTED', '2027-01-05 10:00:00', 'SYSTEM_SEED',
    0, '2027-01-05 10:00:00', 'SYSTEM_SEED', FALSE
) ON CONFLICT (id) DO NOTHING;

-- SEED-CF-002: CFO — 임차료 현금 지급 (2027-01-10, 격리 월)
...
VALUES (
    ...
    'SEED-CF-002', '2027-01-10',
    '[DEV-SEED] CFO — 임차료 현금 지급 (현금흐름표 영업활동 유출 검증)',
    'MANUAL', 'POSTED', '2027-01-10 11:00:00', 'SYSTEM_SEED',
    0, '2027-01-10 11:00:00', 'SYSTEM_SEED', FALSE
) ON CONFLICT (id) DO NOTHING;

-- SEED-CF-003: CFO — 외상매입금 현금 결제 (2027-01-15, 격리 월)
...
VALUES (
    ...
    'SEED-CF-003', '2027-01-15',
    '[DEV-SEED] CFO — 외상매입금 현금 결제 (현금흐름표 영업활동 유출 검증)',
    'MANUAL', 'POSTED', '2027-01-15 14:00:00', 'SYSTEM_SEED',
    0, '2027-01-15 14:00:00', 'SYSTEM_SEED', FALSE
) ON CONFLICT (id) DO NOTHING;
...
VALUES (
    ...
    'SEED-CF-004', '2027-01-20',
    '[DEV-SEED] CFI — 차량운반구 취득 현금 지급 (현금흐름표 투자활동 유출 검증)',
    'MANUAL', 'POSTED', '2027-01-20 09:00:00', 'SYSTEM_SEED',
    0, '2027-01-20 09:00:00', 'SYSTEM_SEED', FALSE
) ON CONFLICT (id) DO NOTHING;

-- SEED-CF-005: CFF — 장기차입금 차입 현금 유입 (2027-01-25, 격리 월)
...
VALUES (
    ...
    'SEED-CF-005', '2027-01-25',
    '[DEV-SEED] CFF — 장기차입금 차입 현금 유입 (현금흐름표 재무활동 유입 검증)',
    'MANUAL', 'POSTED', '2027-01-25 10:00:00', 'SYSTEM_SEED',
    0, '2027-01-25 10:00:00', 'SYSTEM_SEED', FALSE
) ON CONFLICT (id) DO NOTHING;

-- SEED-EQ-001: 유상증자 자본금 납입 (2027-01-02, 격리 월)
...
VALUES (
    ...
    'SEED-EQ-001', '2027-01-02',
    '[DEV-SEED] 유상증자 자본금 납입 (자본변동표 CAPITAL_INCREASE 검증)',
    'MANUAL', 'POSTED', '2027-01-02 09:00:00', 'SYSTEM_SEED',
    0, '2027-01-02 09:00:00', 'SYSTEM_SEED', FALSE
) ON CONFLICT (id) DO NOTHING;

-- SEED-EQ-002: 배당금 지급 (2027-01-30, 격리 월)
...
VALUES (
    ...
    'SEED-EQ-002', '2027-01-30',
    '[DEV-SEED] 배당금 지급 (자본변동표 DIVIDEND 검증)',
    'MANUAL', 'POSTED', '2027-01-30 17:00:00', 'SYSTEM_SEED',
    0, '2027-01-30 17:00:00', 'SYSTEM_SEED', FALSE
) ON CONFLICT (id) DO NOTHING;
...
-- ===== SEED-CF-001 라인 (외상매출금 현금 회수, 2027-01-05) =====
-- 차변: 현금(101) 1,500,000
...
VALUES (
    ...
    '외상매출금 현금 회수',
    '2027-01-05 10:00:00', 'SYSTEM_SEED', FALSE
);
...
-- ===== SEED-CF-002 라인 (임차료 현금 지급, 2027-01-10) =====
-- 차변: 임차료(819) 300,000
INSERT INTO journal_lines
    (id, journal_id, line_no, account_code, debit_amount, credit_amount, memo,
     created_at, created_by, is_deleted)
VALUES (
    ...
    '1월 임차료 (현금 지급)',
    '2027-01-10 11:00:00', 'SYSTEM_SEED', FALSE
);
-- 대변: 현금(101) 300,000
INSERT INTO journal_lines
    (id, journal_id, line_no, account_code, debit_amount, credit_amount, memo,
...
-- ===== SEED-CF-003 라인 (외상매입금 현금 결제, 2027-01-15) =====
...
VALUES (
    ...
    '외상매입금 현금 결제',
    '2027-01-15 14:00:00', 'SYSTEM_SEED', FALSE
);
-- 대변: 현금(101) 800,000
INSERT INTO journal_lines
    (id, journal_id, line_no, account_code, debit_amount, credit_amount, memo,
...
-- ===== SEED-CF-005 라인 (장기차입금 차입, 2027-01-25) =====
...
VALUES (
    ...
    '장기차입금 현금 유입 (CFF)',
    '2027-01-25 10:00:00', 'SYSTEM_SEED', FALSE
);
...
-- ===== SEED-EQ-001 라인 (유상증자 자본금 납입, 2027-01-02) =====
...
VALUES (
    ...
    '유상증자 납입금 입금 (보통예금)',
    '2027-01-02 09:00:00', 'SYSTEM_SEED', FALSE
);
...
-- ===== SEED-EQ-002 라인 (배당금 지급, 2027-01-30) =====
...
VALUES (
    ...
    '2027-01-30 17:00:00', 'SYSTEM_SEED', FALSE
);
...
----------------------------------------------------------------------
-- 검증 요약 (복식부기 균형 확인) — 격리 월 2027-01 기준
