...
/**
 * Samhan Public → arologis 수정 요청 outbound payload — Phase C (BE Task B2).
 *
 * <p>전송 endpoint: {@code POST /internal/arologis/dispatches/{arologisDispatchId}/modification-request}
 * (X-Internal-Token).
 *
