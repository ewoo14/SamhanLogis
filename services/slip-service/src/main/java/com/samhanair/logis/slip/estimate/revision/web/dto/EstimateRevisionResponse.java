package com.samhanair.logis.slip.estimate.revision.web.dto;

import java.time.LocalDate;
import java.time.LocalDateTime;

/**
 * 견적 버전이력 1건 응답 DTO (권한 재편 Phase 2.2 Task 4).
 *
 ...
 *
 * <p>{@link com.samhanair.logis.slip.revision.web.dto.SlipRevisionResponse} 미러
 * (slipNo→estimateNo, slipDate→estimateDate).
 *
 * @param revisionNo estimate 별 단조 증가 버전 번호
