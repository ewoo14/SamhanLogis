 ...
 *
 * <p>협업 알림 수신자 목록에는 과거 데이터의 loginId(username) 와 UUID 문자열이 섞일 수 있다.
...
public class AuthAccountLookupClient {
     ...
     *
     * <p>404/4xx, 5xx, 토큰 미설정, 응답 파싱 실패는 모두 empty 로 반환한다. 알림 발송은
     * best-effort side-effect 이므로 수신자 1명 resolve 실패가 수정완료 트랜잭션을 방해하지 않는다.
     *
