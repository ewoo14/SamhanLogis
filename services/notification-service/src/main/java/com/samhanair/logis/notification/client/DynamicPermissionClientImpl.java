...
/**
 * 동적 RBAC 권한 조회 클라이언트 구현체 — SP-D3 notification-service 이식.
 *
 ...
 * </ul>
 *
 * <p>notification-service 는 {@code restClientBuilder} (기본 빌더) 를 사용.
 *
...
public class DynamicPermissionClientImpl implements DynamicPermissionClient {
     ...
     *
     * @param builder notification-service WebClientConfig 에서 제공하는 기본 빌더
     */
