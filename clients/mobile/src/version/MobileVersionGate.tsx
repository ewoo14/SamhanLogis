...
const STORE_UPDATE_TARGET = {
  iosBundleId: 'com.samhanair.mobile',
  androidPackageName: 'com.samhanair.mobile',
  iosStoreUrl: 'https://apps.apple.com/kr/search?term=SamhanLogis%20%EC%A3%BC%EB%AC%B8',
  androidStoreUrl: 'https://play.google.com/store/apps/details?id=com.samhanair.mobile',
} as const;
