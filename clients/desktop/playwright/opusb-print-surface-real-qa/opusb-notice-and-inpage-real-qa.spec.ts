...
// 패턴으로 통일했었으나, AUDIT_SHOT_DIR 를 안 준 "기본 실행" 자체가 여전히
// docs/qa/choreb-opus-b/ 를 직접 덮어썼다(실 오염 재현, 2026-07-26 하네스 재수렴 라운드
// G2). resolveQaShotsDir 로 한 번 더 감싸 기본값을 _local/ 로 격리한다.
