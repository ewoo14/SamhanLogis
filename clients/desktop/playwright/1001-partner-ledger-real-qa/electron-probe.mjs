...
await page.screenshot({ path: 'D:/dev/Samhan-Public/.claude/worktrees/w1061/docs/qa/1001-partner-ledger-real-qa/00-electron-login.png', fullPage: true })
...
await page.screenshot({ path: 'D:/dev/Samhan-Public/.claude/worktrees/w1061/docs/qa/1001-partner-ledger-real-qa/00-electron-after-login.png', fullPage: true })
await app.close()
