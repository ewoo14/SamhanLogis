...
// Captured 2026-08-09 from the read-only auth_db contract; V99 remains unapplied.
...
// MASTER enforcement is a runtime bypass, not a role-template projection.
// Keep the non-MASTER template snapshot intact and derive MASTER from the
// seven-action runtime rule used by DynamicPermissionService.
export const PERMISSION_BITS_BY_ROLE: Record<string, Record<string, string[]>> = {
  ...TEMPLATE_PERMISSION_BITS_BY_ROLE,
  MASTER: { '1111111': [...PERMISSION_PAGE_CODES] },
}
