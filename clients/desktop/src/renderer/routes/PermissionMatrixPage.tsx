...
export const PAGE_LABEL: Record<PageCode, string> = {
  ...
  'accounting.sales-slip.list': '출고전표',
  'accounting.sales-slip.accounting': '출고전표 회계분개',
  'accounting.purchase-slip.list': '입고전표',
  'accounting.purchase-slip.accounting': '입고전표 회계분개',
  // SP-D1 12개
  ...
  'purchases.slip.list': '입고전표',
  'purchases.slip.edit': '입고 전표 수정',
  'purchases.slip.delete': '입고 전표 삭제',
  'sales.slip.list': '출고전표',
  'sales.slip.create': '출고 전표 생성',
  'sales.slip.edit': '출고 전표 수정',
  ...
  'ecount.mig3.purchase-slip': 'MIG-3 입고전표',
  'ecount.mig3.sales-slip': 'MIG-3 출고전표',
  'ecount.mig3.general-voucher': 'MIG-3 일반전표',
  'ecount.mig3.journal-entry': 'MIG-3 분개',
  'ecount.mig4.tax-invoice': 'MIG-4 세금계산서',
  'ecount.mig4.sales-slip-line': 'MIG-4 출고전표 라인',
