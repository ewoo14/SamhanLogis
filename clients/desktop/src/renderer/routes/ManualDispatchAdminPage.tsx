...
import { Badge, Button, DataTable, Modal, type DataTableColumn } from '@samhan/design-system'
...
export function ManualDispatchAdminPage() {
  ...
  const columns: DataTableColumn<DispatchSummary>[] = [
    ...
    },
    {
      ...
      header: '배차 상태',
      mobilePriority: 'secondary',
      render: (d) => <DispatchStatusBadge status={d.dispatchStatus} />,
    },
    {
      key: 'vehicleCount',
      header: '차량 수',
...
function DriverSelectModal({
  ...
  const columns: DataTableColumn<AvailableDriver>[] = [
    {
      key: 'driverCode',
      header: '기사 코드',
      mobilePriority: 'primary',
    ...
    { key: 'phoneNumber', header: '휴대전화', mobilePriority: 'secondary' },
    {
      ...
      header: '차량 종류',
      mobilePriority: 'secondary',
      render: (driver) => driver.vehicleType ?? '—',
    },
    {
      key: 'source',
      header: '소스',
